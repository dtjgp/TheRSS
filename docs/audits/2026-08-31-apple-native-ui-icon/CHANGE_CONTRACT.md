...
- Git/install/push/publication state: local working tree contains the scoped uncommitted changes. `/Users/dtjgp/Applications/TheRSS Dev.app` is updated with a completed receipt. No commit, branch, push, PR, merge, release, or third-party publication occurred.
