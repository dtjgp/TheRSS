...
**当前本机验收通过。** 用户已授权备份安装和固定 CLI 测试，并将 Apple 付费签名、公证及正式软件发行暂缓。修复版已安装、真实数据保留、实际 Command-Q 与重开正常；见 [本地验收记录](LOCAL_ACCEPTANCE.md)。最新独立授权后，源码分支已推送、[草稿 PR #49](https://github.com/dtjgp/TheRSS/pull/49) 已创建，私密漏洞报告已开启；见 [交付记录](GITHUB_DELIVERY.md)。
